...
public class itsoProfileFragment extends Fragment {
    ...
    private void loadITSOProfileData() {
        ...
        userRef.get(Source.CACHE)
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    if (documentSnapshot.exists()) {
                        bindITSOProfile(documentSnapshot);
                    }
                });
        ...
        profileListener = userRef.addSnapshotListener((documentSnapshot, error) -> {
            ...
            if (error != null) {
                Toast.makeText(
                        requireContext(),
                        "Failed to load ITSO profile: " + error.getMessage(),
                        Toast.LENGTH_LONG
                ).show();
                return;
            }
    ...
    private void bindITSOProfile(DocumentSnapshot documentSnapshot) {
    ...
    private void saveProfileChanges() {
        ...
        db.collection("users")
                ...
                .addOnSuccessListener(unused -> {
                    ...
                    Toast.makeText(requireContext(), "ITSO profile updated successfully", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    if (!isAdded()) return;
    ...
    private String getInitials(String fullName) {
        ...
        return result.isEmpty() ? "IT" : result;
    }
}